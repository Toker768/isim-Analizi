import tkinter as tk                     # import tkinter as tk ifadesi, tkinter kütüphanesini tk kısaltması ile içe
                                         # aktarır. Yani, tk kelimesi, bu durumda tkinter kütüphanesini temsil eder.

def isimisleme():
    # Kullanıcının girdiği ismi al
    isim = entry.get()                                     # entryden aldığım değeri 'isim' değişkenime eşitledim.
